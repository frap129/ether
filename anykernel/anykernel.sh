...
backup_file init.ether.rc;
replace_string init.ether.rc "#    verity_load_state" "    verity_load_state" "#    verity_load_state"
replace_string init.ether.rc "#    verity_update_state" "    verity_update_state" "#    verity_update_state"
